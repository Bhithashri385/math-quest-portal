...
const questionBank = {
    "1-2": [
        ...
        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 64, question: "At a party there are 9 tables with 4 seats each. After everyone sits down, 7 seats are empty. If Greg is one of the people sitting, how many guests came?", options: ["25", "27", "28", "29", "30"], correctAnswer: 2, points: 4 },
        { id: 65, question: "In 36 years, Mark's grandmother will be 100 years old. How old is she now?", options: ["36", "64", "66", "74", "100"], correctAnswer: 1, points: 4 },
        { id: 66, question: "Marko has 9 candies and Tomo has 17 candies. How many candies should Tomo give Marko so they have the same amount?", options: ["2", "3", "4", "5", "6"], correctAnswer: 2, points: 4 },
        { id: 67, question: "A captain was the 8th pirate to climb a rope. There were just as many pirates before him as after him. How many pirates climbed the rope?", options: ["7", "8", "12", "15", "16"], correctAnswer: 3, points: 5 },
        { id: 68, question: "A clothesline uses shared pins: 3 towels need 4 pins. How many pins are needed for 9 towels in one row?", options: ["9", "10", "12", "16", "18"], correctAnswer: 1, points: 4 },
        { id: 69, question: "A zoo has 19 apes and monkeys. There are 4 chimpanzees and 3 baboons. The rest are gorillas split equally into 3 cages. How many gorillas are in each cage?", options: ["3", "4", "5", "6", "7"], correctAnswer: 1, points: 5 }
    ],
    ...
    "3-4": [
        ...
        // === KANGAROO 2017-2025 ECOLIER-STYLE QUESTIONS ===
        // Adapted from the provided Grade 3-4 Ecolier papers
        { id: 173, question: "Each shell is worth 6 points and each marble is worth 1 point. Nora has 4 shells and 3 marbles. What is their total value?", options: ["21", "24", "25", "27", "30"], correctAnswer: 3, points: 3 },
        { id: 174, question: "On a normal die, opposite faces add to 7. If the visible faces are 2, 4, and 6, what is the sum of the hidden faces?", options: ["6", "7", "8", "9", "10"], correctAnswer: 3, points: 3 },
        { id: 175, question: "Six sheep share 245 g of food. Five large sheep each get the same amount, and the small sheep gets twice as much as one large sheep. How much does the small sheep get?", options: ["60 g", "65 g", "70 g", "75 g", "80 g"], correctAnswer: 2, points: 4 },
        { id: 176, question: "Jana has toys weighing 18 g, 22 g, 25 g, 31 g, and 34 g. She divides them into two boxes of equal total weight. Which two toys can make one box by themselves?", options: ["18 g and 34 g", "22 g and 31 g", "25 g and 34 g", "31 g and 34 g", "18 g and 25 g"], correctAnswer: 3, points: 5 },
        { id: 177, question: "A 4 by 7 board has 28 white squares. Ira paints 2 whole rows and 1 whole column. How many white squares remain?", options: ["8", "10", "12", "14", "17"], correctAnswer: 2, points: 3 },
        { id: 178, question: "Lizzy spends 7 identical coins on three fruits. The three prices are different positive whole numbers of coins. What is the largest possible price of the most expensive fruit?", options: ["2 coins", "3 coins", "4 coins", "5 coins", "6 coins"], correctAnswer: 2, points: 3 },
        { id: 179, question: "A parent brings 9 fish home every day for two children. One child gets 5 fish and the other gets 4 fish each day. After several days, one child has received 26 fish. How many fish has the other child received?", options: ["19", "22", "25", "28", "31"], correctAnswer: 3, points: 4 },
        { id: 180, question: "60 children stand in a row. Their vests alternate yellow, green, yellow, green, and their backpacks repeat red, brown, purple. How many children have a yellow vest and a purple backpack?", options: ["3", "4", "6", "8", "10"], correctAnswer: 4, points: 5 },
        { id: 181, question: "For each birthday, Maria gets as many teddy bears as her age. How many teddy bears has she received in total just after her 6th birthday?", options: ["19", "20", "21", "22", "23"], correctAnswer: 2, points: 3 },
        { id: 182, question: "Robert sits in a classroom with 2 children to his left and 3 to his right. There are 2 rows in front of him and 1 row behind him. How many children are in the class?", options: ["8", "15", "18", "20", "24"], correctAnswer: 4, points: 4 },
        { id: 183, question: "Three football teams each play the other teams once. A win gives 3 points and a draw gives 1 point. Which final score is impossible for one team?", options: ["1", "2", "4", "5", "6"], correctAnswer: 3, points: 4 },
        { id: 184, question: "Laura eats 2 more plums than Sophie. Bettina eats 3 fewer than Laura. Clara eats 1 more than Bettina and 3 fewer than Alice. Which two girls eat the same number of plums?", options: ["Alice and Bettina", "Alice and Laura", "Alice and Sophie", "Clara and Laura", "Clara and Sophie"], correctAnswer: 4, points: 5 },
        { id: 185, question: "A gold rocket and a silver rocket make 20 stars in total. The gold rocket makes 6 more stars than the silver rocket. How many stars does the gold rocket make?", options: ["9", "10", "12", "13", "15"], correctAnswer: 3, points: 3 },
        { id: 186, question: "An ice cream shop drawer has some money in it. After 6 ice creams are sold, it has 70 euros. After 16 ice creams are sold, it has 120 euros. How much money was in the drawer at the start?", options: ["20 euros", "30 euros", "40 euros", "50 euros", "60 euros"], correctAnswer: 2, points: 4 },
        { id: 187, question: "A koala eats from 3 branches with 20 leaves each. It eats some leaves from the first branch, then exactly as many from the second as remain on the first, then 2 from the third. How many leaves remain in all?", options: ["20", "22", "28", "32", "38"], correctAnswer: 4, points: 4 },
        { id: 188, question: "Mia hits balloons worth 3, 9, 13, 14, and 18 points and scores exactly 30. Which balloon must she have hit?", options: ["3", "9", "13", "14", "18"], correctAnswer: 0, points: 5 },
        { id: 189, question: "A box has fewer than 50 cookies. They can be shared equally by 2, 3, or 4 children. To share them equally by 7 children, 6 more cookies are needed. How many cookies are in the box?", options: ["12", "24", "30", "36", "48"], correctAnswer: 3, points: 5 },
        { id: 190, question: "A kangaroo starts on step 0 and jumps up 7 steps each time. A rabbit starts on step 100 and jumps down 3 steps each time. When the kangaroo reaches step 56, which step is the rabbit on?", options: ["73", "76", "79", "82", "85"], correctAnswer: 1, points: 4 },
        { id: 191, question: "A parrot's head, tail, and wing are painted red, blue, or green. The head and tail may match, but the wing must be different from both. How many different parrots can be painted?", options: ["3", "6", "9", "12", "15"], correctAnswer: 3, points: 5 },
        { id: 192, question: "Two friends eat one ice cream every vacation day. Each ice cream has 2 or 3 scoops. One friend eats 23 scoops total and the other eats 19. What is the minimum number of vacation days?", options: ["6", "7", "8", "10", "11"], correctAnswer: 2, points: 5 },
        { id: 193, question: "Linda pins photos in a row. Three photos need 8 pins, and each extra photo needs 2 more pins. How many pins are needed for 7 photos?", options: ["14", "16", "18", "22", "26"], correctAnswer: 1, points: 4 },
        { id: 194, question: "A cake is halved, then one piece is halved, then one of those pieces is halved, and then one of the smallest pieces is halved again. If one smallest piece weighs 100 g, how much did the whole cake weigh?", options: ["600 g", "800 g", "1200 g", "1600 g", "2000 g"], correctAnswer: 3, points: 4 },
        { id: 195, question: "A full glass of water weighs 400 g. The empty glass weighs 100 g. How much does the glass weigh when it is half full?", options: ["150 g", "200 g", "225 g", "250 g", "300 g"], correctAnswer: 3, points: 4 },
        { id: 196, question: "A square picture with side length 7 cm needs 32 small squares to make a one-square-wide frame. How many small squares are needed to frame a 10 cm by 10 cm picture?", options: ["36", "40", "44", "48", "52"], correctAnswer: 2, points: 5 },
        { id: 197, question: "The pages of a book are numbered 1, 2, 3, and so on. The digit 5 appears exactly 16 times. What is the largest possible number of pages?", options: ["56", "64", "72", "80", "88"], correctAnswer: 1, points: 5 },
        { id: 198, question: "A farm has 15 animals: cows, cats, and kangaroos. Exactly 10 animals are not cows, and exactly 8 animals are not cats. How many kangaroos are on the farm?", options: ["2", "3", "4", "10", "18"], correctAnswer: 1, points: 5 },
        { id: 199, question: "Susanne is 7 years old. Her sister is 3 years younger, and her brother is 2 years older than Susanne. How old are the three children altogether?", options: ["18", "19", "20", "21", "22"], correctAnswer: 2, points: 3 },
        { id: 200, question: "Leonie has digit stamps from 0 to 9. She stamps the date 21.03.2024. How many different digit stamps does she use?", options: ["4", "5", "6", "7", "8"], correctAnswer: 1, points: 3 },
        { id: 201, question: "On 10 flowers, at most one insect sits on each flower. More than half but fewer than 8 flowers are occupied. The number of butterflies is twice the number of dragonflies. How many butterflies are there?", options: ["2", "3", "4", "5", "6"], correctAnswer: 2, points: 4 },
        { id: 202, question: "A belt has 6 holes in a row, each 2 cm from the next. How much longer is the belt when closed at the first hole instead of the sixth?", options: ["4 cm", "8 cm", "10 cm", "12 cm", "16 cm"], correctAnswer: 2, points: 5 },
        { id: 203, question: "Balloons are sold in packs of 5, 10, or 25. What is the fewest packs needed to buy exactly 85 balloons?", options: ["3", "4", "5", "6", "7"], correctAnswer: 1, points: 4 },
        { id: 204, question: "14 children registered for a contest, then 20 more joined. Six equal teams are needed. How many more children are needed?", options: ["1", "2", "3", "4", "5"], correctAnswer: 1, points: 4 },
        { id: 205, question: "David cooks 5 dishes on 2 burners. The dishes take 30, 20, 45, 15, and 35 minutes. A dish can only be removed when fully cooked. What is the shortest possible cooking time?", options: ["65 min", "70 min", "75 min", "80 min", "85 min"], correctAnswer: 2, points: 5 },
        { id: 206, question: "There are 10 cars in a ferry queue with 24 people altogether. Each car has either 2 or 3 people. How many cars have exactly 2 people?", options: ["4", "5", "6", "7", "8"], correctAnswer: 2, points: 4 },
        { id: 207, question: "Adam and Brenda each have 12 marbles. Together they have 10 white and 14 black marbles. Brenda has twice as many black marbles as white marbles. How many black marbles does Adam have?", options: ["4", "5", "6", "7", "8"], correctAnswer: 2, points: 5 },
        { id: 208, question: "A train line has stations A-B-C-D-E-F and then returns back along the same stations. Starting at B toward C, what is the 32nd stop after it leaves B?", options: ["A", "B", "C", "D", "E"], correctAnswer: 3, points: 5 },

        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 209, question: "A red kangaroo and a gray kangaroo weigh 139 kg together. The red kangaroo weighs 35 kg less than the gray kangaroo. How much does the gray kangaroo weigh?", options: ["52 kg", "53 kg", "87 kg", "96 kg", "104 kg"], correctAnswer: 2, points: 4 },
        { id: 210, question: "A bee visits four flowers: red, blue, yellow, and white. She starts on red, visits each flower once, and never flies directly from yellow to white. How many orders are possible?", options: ["1", "2", "3", "4", "6"], correctAnswer: 3, points: 5 },
        { id: 211, question: "Clara lives 12 floors above Matthew. When Matthew climbs halfway from his apartment to Clara's, he is on the 8th floor. On what floor does Clara live?", options: ["12", "14", "16", "20", "24"], correctAnswer: 1, points: 4 },
        { id: 212, question: "Three students guessed the number of library books: 2010, 1998, and 2015. Their errors were 12, 7, and 5 in some order. How many books were there?", options: ["2003", "2005", "2008", "2020", "2022"], correctAnswer: 0, points: 5 },
        { id: 213, question: "Michael paints one letter of KANGAROO each day. He paints K on Wednesday. What day does he paint the last O?", options: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"], correctAnswer: 2, points: 3 },
        { id: 214, question: "Four friends ended sitting left to right as Masha, Sasha, Dasha, Pasha. Just before that, Dasha and Pasha swapped; before that, Masha and Dasha swapped. What was the original order?", options: ["Masha, Sasha, Dasha, Pasha", "Masha, Dasha, Pasha, Sasha", "Dasha, Sasha, Pasha, Masha", "Sasha, Masha, Dasha, Pasha", "Pasha, Masha, Sasha, Dasha"], correctAnswer: 2, points: 5 },
        { id: 215, question: "Gregory makes two 3-digit numbers using the digits 1, 2, 3, 4, 5, and 6 exactly once. What is the greatest possible sum?", options: ["975", "999", "1083", "1173", "1221"], correctAnswer: 3, points: 5 },
        { id: 216, question: "Pinocchio's nose is 9 cm long. Each lie adds 6 cm and each truth subtracts 2 cm. After 3 lies and 2 truths, how long is it?", options: ["14 cm", "15 cm", "19 cm", "23 cm", "31 cm"], correctAnswer: 3, points: 4 },
        { id: 217, question: "A triangle is reduced by joining side midpoints, then the smaller triangle is reduced the same way. How many of the smallest triangles fit in the original triangle?", options: ["5", "8", "10", "16", "32"], correctAnswer: 3, points: 5 },
        { id: 218, question: "A bowl of candy is halved by Sally, then the remainder is halved by Tom, then the remainder is halved by Clara. If 6 candies remain, how many were there at first?", options: ["12", "18", "20", "24", "48"], correctAnswer: 4, points: 4 },
        { id: 219, question: "A barrel can be filled by 6 small, 3 medium, and 1 large pitcher, or by 2 small, 1 medium, and 3 large pitchers. How many large pitchers alone fill the barrel?", options: ["4", "5", "6", "7", "8"], correctAnswer: 0, points: 5 },
        { id: 220, question: "The digit sum of 2016 is 9. What is the next year after 2016 whose digits also add to 9?", options: ["2007", "2025", "2034", "2108", "2134"], correctAnswer: 1, points: 4 },
        { id: 221, question: "Each magic tree has either 6 pears and 3 apples, or 8 pears and 4 apples. If there are 25 apples in all, how many pears are there?", options: ["35", "40", "45", "50", "56"], correctAnswer: 3, points: 5 }
    ],
    ...
    "5-6": [
        ...
        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 56, question: "A dance group has 39 boys and 23 girls. Each week 6 boys and 8 girls join. When the numbers are equal, how many total participants are there?", options: ["144", "154", "164", "174", "184"], correctAnswer: 3, points: 4 },
        { id: 57, question: "Jane multiplies eighteen 8s and fifty 5s. How many digits are in the product?", options: ["13", "40", "52", "60", "100"], correctAnswer: 2, points: 5 },
        { id: 58, question: "Adam and Tom count chairs around a circular table from different starting chairs. Tom's 20th chair is Adam's 4th, and Tom's 10th is Adam's 46th. How many chairs are there?", options: ["50", "52", "56", "60", "80"], correctAnswer: 1, points: 5 },
        { id: 59, question: "Basil writes one letter of KANGAROO each day. He writes K on Wednesday. On what day does he finish?", options: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"], correctAnswer: 2, points: 3 },
        { id: 60, question: "Five cities are all connected pairwise by roads. If 7 of the roads are visible, how many roads are invisible?", options: ["2", "3", "5", "7", "10"], correctAnswer: 1, points: 4 },
        { id: 61, question: "A number leaves remainder 7 when divided by 9. What remainder does twice the number leave when divided by 9?", options: ["1", "2", "5", "6", "7"], correctAnswer: 2, points: 4 },
        { id: 62, question: "Mary, Ann, and Nata run a kindergarten. Exactly two work each weekday. Mary works 3 days and Ann works 4 days. How many days does Nata work?", options: ["1", "2", "3", "4", "5"], correctAnswer: 2, points: 4 }
    ],
    ...
    "7-8": [
        ...
        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 56, question: "Four boys report dancing with 3, 1, 2, and 2 girls. Three girls report dancing with 2, 2, and 2 boys. How many boys did the fourth girl dance with?", options: ["0", "1", "2", "3", "4"], correctAnswer: 2, points: 3 },
        { id: 57, question: "A woodcutter makes 53 cuts, each cut splitting one piece into two. If he ends with 72 pieces, how many pieces did he start with?", options: ["17", "18", "19", "20", "21"], correctAnswer: 2, points: 4 },
        { id: 58, question: "Ellie has 5 cubes and 3 tetrahedrons. Counting faces, how many sides do all the solids have together?", options: ["42", "48", "50", "52", "56"], correctAnswer: 0, points: 3 },
        { id: 59, question: "A soccer team scored 3 goals and allowed 1 goal over three games: one win, one loss, and one tie. What was the score of the game it won?", options: ["2-0", "1-0", "2-1", "3-1", "3-0"], correctAnswer: 4, points: 4 },
        { id: 60, question: "The Math Kangaroo contest is on the third Thursday of March. What is the latest possible date for it?", options: ["March 14", "March 15", "March 20", "March 21", "March 22"], correctAnswer: 3, points: 3 },
        { id: 61, question: "Twelve students eat 18 cupcakes total. Nobody eats more than 2, and 2 students eat none. How many students eat 2 cupcakes?", options: ["2", "5", "6", "7", "8"], correctAnswer: 4, points: 5 }
    ],
    ...
    "9-10": [
        ...
        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 56, question: "Which expression is a multiple of 3?", options: ["2009", "2 + 0 + 0 + 9", "(2 + 0)(0 + 9)", "29", "200 - 9"], correctAnswer: 2, points: 3 },
        { id: 57, question: "In 2010, a teacher says the product of his age and his father's age is 2010. Which birth year is possible for the teacher?", options: ["1943", "1953", "1980", "1981", "1995"], correctAnswer: 2, points: 3 },
        { id: 58, question: "How many 3-digit numbers have a middle digit equal to the average of the first and last digits?", options: ["25", "29", "41", "45", "50"], correctAnswer: 3, points: 5 },
        { id: 59, question: "Adam on a table is 80 cm taller than Mike on the floor. Mike on the same table is 100 cm taller than Adam on the floor. How high is the table?", options: ["20 cm", "80 cm", "90 cm", "100 cm", "120 cm"], correctAnswer: 2, points: 4 },
        { id: 60, question: "What is the ones digit of 2015² + 2015⁰ + 2015¹ + 2015⁵?", options: ["1", "5", "6", "7", "9"], correctAnswer: 2, points: 3 },
        { id: 61, question: "Petra has 3 different dictionaries and 2 different novels. How many shelf arrangements keep the dictionaries together and the novels together?", options: ["12", "24", "30", "60", "120"], correctAnswer: 1, points: 5 },
        { id: 62, question: "On a 30-question test, Ruth has 50% more right answers than wrong answers. She answered every question. How many were correct?", options: ["10", "12", "15", "18", "20"], correctAnswer: 3, points: 4 },
        { id: 63, question: "A plant wraps 5 times around a 1 m pole with circumference 15 cm, rising at a constant rate. What is the plant's length?", options: ["0.75 m", "1.0 m", "1.25 m", "1.5 m", "1.75 m"], correctAnswer: 2, points: 5 }
    ],
    ...
    "11-12": [
        ...
        // === MATH KANGAROO USA 2009-2016 SAMPLE QUESTIONS ===
        { id: 56, question: "For how many positive integers n is n² + n prime?", options: ["0", "1", "2", "Finitely many more than 2", "Infinitely many"], correctAnswer: 1, points: 3 },
        { id: 57, question: "Which number could be the number of edges of a prism?", options: ["100", "200", "2008", "2009", "2010"], correctAnswer: 4, points: 3 },
        { id: 58, question: "For any positive integer, the difference between the integer and the sum of its digits is always divisible by what?", options: ["2", "5", "7", "11", "9"], correctAnswer: 4, points: 3 },
        { id: 59, question: "Among n-digit numbers with no zeroes, the count with no 9s equals the count with exactly one 9. What is n?", options: ["8", "9", "12", "15", "2011"], correctAnswer: 0, points: 4 },
        { id: 60, question: "In a number pyramid, the top is the product of the two entries below it, repeated upward. If the three bottom entries are natural numbers greater than 1, which number cannot be the top?", options: ["56", "84", "90", "105", "220"], correctAnswer: 3, points: 4 }
    ]
};
